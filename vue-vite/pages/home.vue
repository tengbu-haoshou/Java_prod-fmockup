...
<script setup>
	...
	function receive_texts(texts_status, texts_message, texts_value) {
		if (texts_status == 'action-ok') {
			...
			text_tab_home.value = texts_json.home_tab_home
			text_tab_password.value = texts_json.home_tab_password
			text_tab_about.value = texts_json.home_tab_about
			text_welcome.value = texts_json.home_welcome
		} else {
			display.value = 'error'
